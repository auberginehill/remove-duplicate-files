        ...
        <td style="padding:6px">
            <ol>
                ...
                <p>
                    ...
                    Run the script and delete all duplicate files found in <code>C:\dc01</code> and in every subfolder under <code>C:\dc01</code>. The duplicate files are searched in each folder separately and multiple occurrances of a file are deleted only within one folder (so if a file exists twice in Folder A and also once in Folder B, only the second instance of the file in Folder A would be deleted).
                    <br />
